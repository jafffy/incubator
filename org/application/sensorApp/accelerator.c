...
#define  ACCEL_NAME		"bma250"
//#define  ACCEL_NAME		"Sleep Button"
...
int main(int argc, char *argv[])
{
	...
	printf("Parcing BMA250 inputX...\n");

	if (argc != 2)
	{
		printf("Usage : acceleratin <read Number>\n");
		return 1;
	}
	...
	sprintf(strshellcmd,"echo '0'> %smode\n",strSysPath);
	printf(strshellcmd);
	system(strshellcmd);
